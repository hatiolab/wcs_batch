...
public class CtrlWcs_BoxSorter {

	public static String TAG = CtrlWcs_BoxSorter.class.getSimpleName();
	...
	public static void main(String[] args) {
		...
		try {
			...
			IExtractor extractor = new BoxSorterResult(yyyymmdd, wcsCon, ctrlWcsCon);
			extractor.extract();
		}catch (Exception e) {
			//e.printStackTrace();
